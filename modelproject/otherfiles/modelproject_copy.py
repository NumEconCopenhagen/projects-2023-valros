...
class SolowModelClass:
    ...
    def simulate(self,do_print=False):
        ...
        if do_print == True:
            ...
            ax[0,1].plot(sim.t,sim.R,label='$R_t$')
            ax[0,1].set_title('Limited ressource')
            ax[0,2].plot(sim.t,sim.L,label='$L_t$')
            ax[0,2].set_title('Labor')
            ax[1,0].plot(sim.t,sim.A,label='$A_t$')
            ax[1,0].set_title('Technology')
            ax[1,1].plot(sim.t,sim.E,label='$E_t$')
            ax[1,1].set_title('Consumption of limited ressource')
            ax[1,2].plot(sim.t,sim.Y,label='$Y_t$')
            ax[1,2].set_title('Output')
            #ax[1,3].plot(sim.t,sim.z,label='$z_t$')
            #ax.legend()
            plt.show()
